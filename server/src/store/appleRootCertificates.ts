// Certificados raiz públicos obtidos da página Apple PKI. Eles não são
// segredos; ficam versionados para a validação não depender de rede no boot.
// Fontes:
// https://www.apple.com/certificateauthority/AppleRootCA-G2.cer
// https://www.apple.com/certificateauthority/AppleRootCA-G3.cer
export const APPLE_ROOT_CA_G2 = `-----BEGIN CERTIFICATE-----
